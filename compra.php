...
<div class="container text-center">
  <div class="row">
    ...
    <?php
        $result_pro=$conn->query("SELECT * from productos");
    ...
    <div class='col-4 poppins-medium'>
      <div class='card c-1 mb-4' style='width: 18rem;'>
        ...
        <div class='card-body'>
          ...
          <button class='btn  btn1' data-bs-target='#<?= $modal_id ?>' data-bs-toggle='modal'>¡Comprar
            ya!</button>
        </div>
            ...
            <div class='modal-content'>
                ...
                <div class='col-7'>
                  ...
                  <form method='post'>
                    ...
                    <div class='mb-3 row'>
                      ...
                      <div class='col-sm-7'>
                        <input type='detalle' readonly class='form-control-plaintext' style="max-width:80px;"
                    ...
                    <div class='mb-3 row'>
                      <!-- Cantidad -->
                      <label for='cantidad<?=$row_pro['id']?>' class='col-sm-5 col-form-labell'>Cantidad:</label>
                      <div class='col-sm-7'>
                        <input type='range' class='form-range' min='1' max='5' name="cantidad"
                          id='cantidad<?=$row_pro['id']?>'>

                        <output for='cantidad' id='rangeValue<?=$row_pro['id']?>' aria-hidden='true'></output>
              ...
              <div class='modal-footer'>
                ...
                <form method='post'>
                  ...
                  <!-- cantidad -->
                  <input type='hidden' name='cantidad' id='cantidadInput<?=$row_pro['id']?>' value='3'>
                  ...
                  <input type='submit' value='Comprar' class='btn btn-outline-success toast-trigger'>
                </form>
